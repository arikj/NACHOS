...
int schedalgo, FCFS, SJF, RR1, RR2, RR3, RR4, UP1, UP2, UP3, UP4;
int quanta1, quanta2, quanta3, quanta4;
unsigned nextQuanta;
unsigned quantaTicks;
...
TimerInterruptHandler(int dummy)
{
	...
	DEBUG('q', "total ticks: %d   nextQuanta at %d\n", stats->totalTicks, nextQuanta);
	if(schedalgo >= RR1 && nextQuanta <= (unsigned)stats->totalTicks)
		{
		interrupt->YieldOnReturn();
		DEBUG('q', "Yielding after quanta. Next quanta set as %d:: present ticks=%d\n", nextQuanta, stats->totalTicks);
		}
...
Initialize(int argc, char **argv)
{
    ...
    quanta3 = 90;
    quanta4 = 20;	
    FCFS=1; SJF=2; RR1=3; RR2=4; RR3=5; RR4=6; UP1=7; UP2=8; UP3=9; UP4=10;	
    nextQuanta = 0;
    quantaTicks = 100;	
