...
extern int schedalgo;				// type of scheduling  algorithm
extern int FCFS, SJF, RR1, RR2, RR3, RR4, UP1, UP2, UP3, UP4;	// types of scheduling algorithm 
extern int quanta1, quanta2, quanta3, quanta4;
extern unsigned nextQuanta;			// timer ticks for context switch at next quanta
extern unsigned quantaTicks;			// quanta ticks	
