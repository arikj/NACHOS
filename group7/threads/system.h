...
extern void Cleanup();				// Cleanup, called when
						// Nachos is done.
extern int semAllocate(int gkey);
extern int condAllocate(int gkey);
extern Thread *currentThread;			// the thread holding the CPU
extern Thread *threadToBeDestroyed;  		// the thread that just finished

extern Semaphore *semaphoreList[];         //semaphore list
extern int semNextId;

extern Condition *condList[];
extern int condNextId;
...
extern Inverted invertTable[NumPhysPages];
